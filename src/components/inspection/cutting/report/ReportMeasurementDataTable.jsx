...
//     });
//   });
//   const sortedPcsNames = Array.from(allPcsNames).sort((a, b) => {
...
//                 <th key={pcsName} className="border border-gray-300 p-1">
//                   {pcsName}
//                 </th>
//               ))}
//             </tr>
...
//                       if (
//                         tolerance &&
//                         (measurement.valuedecimal < tolerance.min ||
//                           measurement.valuedecimal > tolerance.max)
//                       ) {
//                         isFail = true;
//                       }
//                       break;
