...
//         panelIndexNameChinese: "", // Initialize as empty string
//         panelName: "NA",
//         panelSide: "NA",
//         panelDirection: "NA",
//         measurementSide: "NA",
...
//         pointNameChinese: "" // Initialize as empty string
//       }
//     ]);
//   };
...
//         updatedPoints[index].panelIndexNameChinese = ""; // Set to empty string
//       } else {
//         updatedPoints[index].panelIndexName = value;
//         updatedPoints[index].panelIndexNameKhmer = "";
//         updatedPoints[index].panelIndexNameChinese = ""; // Set to empty string
...
//     try {
//       // Find the selected garment type to get panelKhmer
//       const selectedGarment = garmentTypes.find(
//         (type) => type.panel === selectedGarmentType
//       );
//       const panelKhmer = selectedGarment
//         ? selectedGarment.panelKhmer || ""
//         : "";
...
//             panelIndexNameChinese: "" // Set to empty string
//           },
//           {
//             headers: { "Content-Type": "application/json" },
//             withCredentials: true
...
//           {garmentTypes && Array.isArray(garmentTypes) ? (
...
//               {t("cutting.noGarmentTypesAvailable")}
//             </option>
//           )}
//         </select>
//       </div>
...
const CuttingOrderModify = () => {
  ...
  const handlePointChange = async (index, field, value) => {
    ...
    if (field === "panelIndexName") {
      ...
      if (selectedPanel) {
        ...
        updatedPoints[index].panelIndexNameKhmer =
          selectedPanel.panelIndexNameKhmer || "";
        updatedPoints[index].panelIndexNameChinese =
          selectedPanel.panelIndexNameChinese || ""; // Autofill from panelIndexNames
      } else {
        updatedPoints[index].panelIndexName = value;
        updatedPoints[index].panelIndexNameKhmer = "";
        updatedPoints[index].panelIndexNameChinese = ""; // Set to empty string for custom input
        updatedPoints[index].panelIndex = updatedPoints[index].panelIndex || 1;
      }
    } else {
      updatedPoints[index][field] = value;
  ...
  const handleSave = async () => {
    ...
    try {
      // Find the selected garment type to get panelKhmer and panelChinese
      const selectedGarment = garmentTypes.find(
        (type) => type.panel === selectedGarmentType
      );
      const panelKhmer = selectedGarment
        ? selectedGarment.panelKhmer || ""
        : "";
      const panelChinese = selectedGarment
        ? selectedGarment.panelChinese || ""
        : "";
      ...
      for (const point of additionalPoints) {
        await axios.post(
          `${API_BASE_URL}/api/save-measurement-point`,
          {
            moNo,
            panel: selectedGarmentType,
            panelKhmer, // Autofill from garmentTypes
            panelChinese, // Autofill from garmentTypes
            pointName: point.measurementPointEng,
            pointNameEng: point.measurementPointEng,
            pointNameKhmer: point.measurementPointKhmer,
            pointNameChinese: "", // Set to empty string
            ...
            panelIndexName: point.panelIndexName,
            panelIndexNameKhmer: point.panelIndexNameKhmer,
            panelIndexNameChinese: point.panelIndexNameChinese // Use from additionalPoints
          },
          {
            headers: { "Content-Type": "application/json" },
            withCredentials: true
