...
//   const handleDeleteClick = async (moNo, referenceNo) => {
...
//     try {
//       await axios.delete(`${API_BASE_URL}/api/delete-measurement-record`, {
//         data: { moNo, referenceNo },
//         withCredentials: true,
//         headers: {
...
//       );
//       alert(
//         `Failed to delete the measurement record: ${
//           error.response?.data?.error || error.message
//         }`
//       );
//     }
